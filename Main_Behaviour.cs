...
public class Main_Behaviour : MonoBehaviour
{
    ...
    public Dictionary<string, TextAsset> StoryDictionary = new Dictionary<string, TextAsset>();
    ...
    public void CreateObjects()
    {
        ...
        GameState miningCampSteal = new GameState(
            ...
            new []
            {
                new Vector3(1.12f, 11.37f, -1f),
                new Vector3(0.37f, 8.08f, -1f),
                new Vector3(-0.96f, 5.25f, -1f),
                new Vector3(1.48f, 3.1f, -1f),
                new Vector3(3.35f, 2.18f, -1f),
                new Vector3(3.6f, 0.47f, -1f),
                new Vector3(1.902f, 0.746f, -1f),
            },
            "MiningCampStealEnding",
            new AttributeCheck(true)
        );
        ...
        GameState toDragon = new GameState(
            ...
            new Vector3(18.91f, -6f),
            new GameState[] {},
            new []
            {
                new Vector3(18.86f, -4.75f, -1f),
                new Vector3(17.43f, -5.34f, -1f),
                new Vector3(18.91f, -6f, -1f),
        ...
        GameState toTower = new GameState(
            "goToTower",
            new Cards(Resources.Load<Sprite>("cards_faces/ToDragon")),
        ...
        GameState stealArmor = new GameState(
            ...
            new Vector3(10.37f, -3.26f),
            new [] {toTower},
            new []
            {
                new Vector3(5f, -4.95f, -1f),
            },
            "StealArmor",
        ...
        GameState shop = new GameState(
            "Shop",
            new Cards(Resources.Load<Sprite>("cards_faces/shop")),
            new Vector3(3.529f, -2.451f),
        ...
        GameState quest = new GameState(
            "cityQuest",
            new Cards(Resources.Load<Sprite>("cards_faces/QuestInCity")),
        ...
        PlayerPoint = home;
        //TODO: make player object have it store all the items and stats
        CoinUpdate = buyArmor;
...
//Move player
    private async void MoveMe(GameState currentState)
    {
        ...
        StartCoroutine(AudioScript.PlaySound());//Check witch sound zone the player is currently in after evry step and at the end of the move
    }
...
//Generate card faces for next possible moves
    private async void ChangeButtonImg(GameState currentState)
    {
        ...
        {
            var currentCard = menuCards[cardIndex];
        ...
        while (cardIndex < menuCards.Length)//hide cards if they are currently showing
        {
            menuCards[cardIndex].gameObject.SetActive(false);
            cardIndex++;
        }
    }

    /*                         array.IsActive method^^^^
